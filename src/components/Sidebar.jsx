...
export default function Sidebar() {
                    ...
                    {isActive && (
                        <>
                            <div style={{
                                ...
                                boxShadow: '16px 16px 0 16px #F8FAFC', pointerEvents: 'none'
                            }}></div>
                            <div style={{
    ...
    return (
        <aside
            className="w-64 bg-hx-blue flex flex-col justify-between fixed h-screen top-0 left-0 z-50 overflow-hidden shadow-2xl"
        >
            <div className="pt-6 pb-4">
                ...
                <ul className="flex flex-col relative">
                    ...
                    <MenuItem 
                        path="/aulas" 
                        label="Aulas" 
                        icon={<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M18 20V6a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v14"></path><path d="M2 20h20"></path><path d="M14 12v.01"></path></svg>}
                    />

                    <MenuItem 
                        path="/grados" 
                        label="Grados" 
                        icon={<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M22 10v6M2 10l10-5 10 5-10 5zM6 12v5c3 3 9 3 12 0v-5"></path></svg>}
                    />
                </ul>
            </div>
            ...
            <div className="p-6">
                <a
                    href="#"
                    className="flex items-center gap-3 text-white/80 font-bold px-4 py-3 hover:bg-white/10 hover:text-white rounded-xl transition-all outline-none"
                >
